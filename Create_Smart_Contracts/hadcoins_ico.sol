...
contract hadcoin_ico {
    ...
    // Introducing the total number of Hadcoins that have been
    // Bought by Investors
    uint public total_hadcoins_bought = 0;

    // Mapping from inverstors address to its equity in Hadcoins and USD
    mapping(address => uint) equity_hadcoins;
    mapping(address => uint) equity_usd;

    // Check if an investors can buy Hadcoins
