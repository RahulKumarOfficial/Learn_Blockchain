# -*- coding: utf-8 -*-
"""
Created on Mon Jun 29 21:39:02 2020
...
def is_valid():
    ...
    response = {'value': blockchain.is_chain_valid(chain)
                }
    return jsonify(response), 200
...
def add_transaction():
    ...
    index = blockchain.add_transaction(json['sender'], json['receiver'],
                                       json['amount'])
    response = {'message':
                f'This Transaction will be added to the Block{index}'}
...
def connect_node():
    ...
    response = {'message': 'All nodes are connected as follows',
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message': 'Different chains found, replaced by longest',
                    'new_chain': blockchain.chain
                    }
    else:
        response = {'message': 'Current chain is largest',
